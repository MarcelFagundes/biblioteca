...
import com.bibliotecalivrosemprestimos.adapter.input.web.UsuarioController;
import com.bibliotecalivrosemprestimos.adapter.input.web.dto.UsuarioDTO;
import com.bibliotecalivrosemprestimos.application.UsuarioService;
import com.bibliotecalivrosemprestimos.domain.Usuario;
...
class UsuarioControllerTest {
    ...
    void criarUsuario_DeveRetornarUsuarioCriado() {
        // Arrange
        UsuarioDTO requestDTO = new UsuarioDTO(null, "João Silva", "joao@email.com", "12345678900");
        Usuario usuarioSalvo = new Usuario("1", "João Silva", "joao@email.com", "12345678900");

        when(service.criar(any(Usuario.class))).thenReturn(usuarioSalvo);
